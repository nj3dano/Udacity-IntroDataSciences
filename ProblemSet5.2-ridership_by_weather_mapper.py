# -*- coding: utf-8 -*-
"""
Created on Mon Mar 02 17:37:56 2015
...
def mapper():
    ...
    for line in sys.stdin:
        ...
        # for each unit, emit a key value pair
        # fog is column 15, rain is column 16, hourly entries the 7th
        myKey = format_key(float(data[14]),float(data[15]))
        print "{0}\t{1}".format(myKey, data[6])
