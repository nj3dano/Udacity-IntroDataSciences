...
def mapper():
    ...
    for line in sys.stdin:
        ...
        # throw out the header, expect each row to be a length of 12
        if data[0] == 'Registrar' or len(data) != 12:
            continue
        
        # emit key-value pair containing the 
        # district (not state), 4th column (remember zero indexing)
        # and Aadhaar generated, 9th column         
